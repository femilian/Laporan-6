...
public class Manager extends Employee {
    ...
    public void lamaKerja(){
        ...
        if (lama <= 5){
            ...
            System.out.println("Mendapatkan Bonus Sebesar      : Rp. "+Math.ceil(bonus));
            System.out.println("Gaji Total                     : Rp. "+Math.floor(total));
        }
    }
    public void istri(){
        tistri = 0.1 * total;
    ...
    public void jabatan(){
        tjabatan = 0.1*total;
        System.out.println("Mendapatkan Tunjangan Jabatan Sebesar  : Rp. "+Math.ceil(tjabatan));
    }
}
